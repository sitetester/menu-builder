...
return $this->services['App\Controller\CategoryController'] = new \App\Controller\CategoryController(($this->privates['App\Service\CategoriesManager'] ?? $this->load(__DIR__.'/getCategoriesManagerService.php')));
