...
$a->setNamespace('sf_orm_default_a1e1c475ea3d6fa272e135c6af4cd1eb65ab20256543500ce90621df282beadb');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_a1e1c475ea3d6fa272e135c6af4cd1eb65ab20256543500ce90621df282beadb');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_a1e1c475ea3d6fa272e135c6af4cd1eb65ab20256543500ce90621df282beadb');

$d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/config/doctrine') => 'App\\Entity'));
...
$f->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoryRepository' => function () {
    return ($this->privates['App\Repository\CategoryRepository'] ?? $this->load(__DIR__.'/getCategoryRepositoryService.php'));
...
$this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create(($this->services['doctrine.dbal.pgsql_connection'] ?? $this->load(__DIR__.'/getDoctrine_Dbal_PgsqlConnectionService.php')), $f);
